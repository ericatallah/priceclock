...
module.exports = {
  ...
  MESSARI_SOLANA_DATA_URL: 'https://data.messari.io/api/v1/assets/ethereum/metrics?fields=market_data/price_usd',
  ...
  COIN_GECKO_DATA_URL: 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,thorchain,hytopia,pepefork,solana&vs_currencies=usd',
  ...
  CMC_DATA_URL: `https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?symbol=BTC,ETH,XRP,RUNE,TOPIA,PNDC,PORK,SOL&CMC_PRO_API_KEY=${process.env.CMC_KEY}`,
