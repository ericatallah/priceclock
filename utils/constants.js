...
module.exports = {
  ...
  COIN_GECKO_DATA_URL: 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,thorchain,hytopia,pepe&vs_currencies=usd',
  ...
  CMC_DATA_URL: `https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?symbol=BTC,ETH,XRP,RUNE,TOPIA,PNDC,PEPE&CMC_PRO_API_KEY=${process.env.CMC_KEY}`,
};
